...
GITHUB_TOKEN = "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"
...
def configure_ngrok_with_retry():
    ngrok_token = "2rZAFQnWsYru886oYf0Xt8niLkD_88i9KLPCpJA2Zkiw1DAFC"
...
def create_github_repo():
    ...
    repo_data = {
        "name": "soul",
        "description": "Repository for jony5.txt",
        "private": False,
    }
    try:
...
def update_jony5_txt(public_url):
    file_path = "jony5.txt"
