...
def configure_ngrok_with_retry():
    ngrok_token = "2rZA6D0col8HqZq6wBkMamnVHHO_EzPZJFwT5gd9cmqSxnWk"
...
def create_github_repo():
    ...
    repo_data = {
        "name": "soul",
        "description": "Repository for jony3.txt",
        "private": False,
    }
    try:
...
def update_jony3_txt(public_url):
    file_path = "jony3.txt"
