...
GITHUB_TOKEN = "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"  # Replace with your actual GitHub token
...
def configure_ngrok_with_retry():
    ngrok_token = "2rablwBOiaKoqYcmuYTGEzib8Ro_3vXVVXrA5icYSZWCPyjL"  # Replace with your actual ngrok token
...
def create_github_repo():
    ...
    repo_data = {
        "name": "soul",
        "description": "Repository for jony4.txt",
        "private": False,
    }
    try:
...
def upload_to_github(file_path):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"File {file_name} does not exist on GitHub. A new file will be created.")
        else:
...
def update_jony4_txt(public_url):
    file_path = "jony4.txt"
